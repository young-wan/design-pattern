package com.young.design_pattern.create_mode.DP_3.Pack1;

import com.young.design_pattern.create_mode.DP_3.Celling.LevelOneCeiling;
import com.young.design_pattern.create_mode.DP_3.Celling.LevelTwoCeiling;
import com.young.design_pattern.create_mode.DP_3.Coat.DuluxCoat;
import com.young.design_pattern.create_mode.DP_3.Coat.LiBangCoat;
import com.young.design_pattern.create_mode.DP_3.Floor.ShengXiangFloor;
import com.young.design_pattern.create_mode.DP_3.Matter;
import com.young.design_pattern.create_mode.DP_3.Tile.DongPengTile;
import com.young.design_pattern.create_mode.DP_3.Tile.MarcoPoloTile;
...
public class DecorationPackageController {
    public String getMatterList(BigDecimal area, Integer level) {
        ...
        for (Matter matter : list) {
            ...
            detail.append(matter.scene()).append("：").append(matter.brand()).append("、").append(matter.model()).append("、平⽶价格：")
